...
class SpecSynchronizer:
    ...
    def needs_sync(self, force: bool = False) -> bool:
        ...
        if stored_hash is None:
            print("[!] No stored hash found. First-time sync required.")
            return True
    ...
    def _generate_slug(self, cn_title: str) -> str:
        ...
        print(f"[!] No slug mapping for '{cn_title}'. Using sanitized title.")
        print(f"    [i] Tip: Add this to TITLE_SLUG_MAP for better filenames.")
