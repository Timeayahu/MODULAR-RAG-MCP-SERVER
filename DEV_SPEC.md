...
## 1. 项目概述
本项目基于多阶段检索增强生成（RAG, Retrieval-Augmented Generation）与模型组合平台（MCP, Model Composition Platform）设计，目标是搭建一个可扩展、高可观测、易迭代的智能问答与知识检索框架。
...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-01-26 | |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-01-26 | |
| A3 | 配置加载与校验（Settings） | [x] | 2026-01-26 | |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-01-26 | |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026-01-26 | |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026-01-26 | |
...
| B7.3 | OpenAI Embedding 实现 | [x] | 2026-01-27 | |
| B7.4 | Local Embedding 实现 | [x] | 2026-01-27 | |
| B7.5 | Recursive Splitter 默认实现 | [x] | 2026-01-27 | |
| B7.6 | ChromaStore 默认实现 | [x] | 2026-01-27 | |
| B7.7 | LLM Reranker 实现 | [x] | 2026-01-27 | |
| B7.8 | Cross-Encoder Reranker 实现 | [x] | 2026-01-27 | |
...
| C7 | ImageCaptioner | [x] | 2026-01-28 | |
| C8 | DenseEncoder | [x] | 2026-01-28 | |
| C9 | SparseEncoder | [x] | 2026-01-28 | |
| C10 | BatchProcessor | [x] | 2026-01-28 | |
| C11 | VectorUpserter | [x] | 2026-01-28 | |
| C12 | BM25Indexer | [x] | 2026-01-28 | |
| C13 | ImageStorage | [x] | 2026-01-28 | |
| C14 | Pipeline 编排（MVP 串起来） | [x] | 2026-01-28 | |
| C15 | 脚本入口 ingest.py | [x] | 2026-01-28 | |
...
| D2 | DenseRetriever | [x] | 2026-02-08 | |
| D3 | SparseRetriever（BM25） | [x] | 2026-02-08 | |
| D4 | RRF Fusion | [ ] | - | |
| D5 | MetadataFilter | [ ] | - | |
